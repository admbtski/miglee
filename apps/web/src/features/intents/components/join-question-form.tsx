...
import type { IntentJoinQuestionsQuery } from '@/lib/api/__generated__/react-query-update';

type JoinQuestion = IntentJoinQuestionsQuery['intentJoinQuestions'][0];
...
/**
 * Form for users to answer join questions when requesting to join an intent
 */
