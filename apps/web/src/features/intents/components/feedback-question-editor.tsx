...
/**
 * Editor for managing feedback questions (owner/mod only)
 * Similar to JoinQuestionEditor but for post-event feedback
 */
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-amber-800 dark:text-amber-200 mt-1">
              {lockReason || 'Nie możesz edytować pytań feedbackowych.'}
            </p>
          </div>
        </div>
