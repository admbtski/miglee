...
import { formatDate, formatTime } from '@/features/intents/utils/date-format';
import type { EventDetailsData } from '@/features/intents/types/event-details';
import { formatParticipantsShort } from '@/features/intents/utils/capacity-formatter';
import {
  Calendar,
  MapPin,
  MapPinned,
