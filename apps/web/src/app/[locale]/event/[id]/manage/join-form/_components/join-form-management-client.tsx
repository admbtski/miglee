...
export function JoinFormManagementClient({
  ...
  const sponsorshipPlan = event?.sponsorshipPlan as SponsorshipPlan;
  ...
  return (
    <PlanUpgradeBanner
      ...
      requiredPlan="PLUS"
      featureName="Formularz dołączenia dostępny w planach Plus i Pro"
      featureDescription="Zbieraj dodatkowe informacje od uczestników przed zatwierdzeniem. Twórz niestandardowe pytania i przeglądaj odpowiedzi przy akceptacji zgłoszeń."
      eventId={eventId}
    >
            ...
            {questions.length === 0 ? (
              <div className="p-8 text-center border-2 border-dashed rounded-lg border-zinc-300 dark:border-zinc-700">
                ...
                <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
                  Dodaj pierwsze pytanie, aby zacząć budować formularz
                  dołączania
                </p>
                <button
                  onClick={handleAddQuestion}
