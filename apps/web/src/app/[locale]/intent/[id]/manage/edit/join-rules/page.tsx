...
export default function JoinRulesPage() {
  ...
  useEffect(() => {
    ...
    setJoinOpensMinutesBeforeStart(intent.joinOpensMinutesBeforeStart);
    setJoinCutoffMinutesBeforeStart(intent.joinCutoffMinutesBeforeStart);
    setAllowJoinLate(intent.allowJoinLate ?? true);
    setLateJoinCutoffMinutesAfterStart(intent.lateJoinCutoffMinutesAfterStart);
    setIsDirty(false);
    ...
    const matchingPreset = JOIN_PRESETS.find(
      (p) =>
        p.values.joinOpensMinutesBeforeStart ===
          intent.joinOpensMinutesBeforeStart &&
        p.values.joinCutoffMinutesBeforeStart ===
          intent.joinCutoffMinutesBeforeStart &&
        p.values.allowJoinLate === intent.allowJoinLate &&
