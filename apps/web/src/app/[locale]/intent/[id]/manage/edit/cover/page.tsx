...
export default function CoverPage() {
  const { intent, intentId, isLoading, refetch } = useEdit();
  ...
  // Current cover URL
  const currentCover = intent?.coverKey
    ? buildIntentCoverUrl(intent.coverKey, 'detail')
    : null;
  ...
  const handleSave = async () => {
    ...
    try {
      await uploadIntentCover(intentId, selectedFile, {
