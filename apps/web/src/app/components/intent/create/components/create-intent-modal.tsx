...
export function CreateIntentModal({
  ...
  const validateStep = useCallback(
    async (index: number) => {
      switch (index) {
        case 0:
          // Basics (+ meetingKind/onlineUrl primary constraints)
          return await trigger(['title', 'interestIds']);
        case 1:
          // Capacity
        ...
        case 3:
          // Place (+ visibility/notes live on this step in UI)
          return await trigger([
            ...
            'visibility',
            'notes',
            'meetingKind', // hybrid/site rules can error here too
            'onlineUrl',
          ]);
        default:
          return true;
  ...
  /**
   * Final submit -> map Date to ISO, keep schema alignment (meetingKind/onlineUrl).
   */
    ...
    <Modal
      ...
      content={
        <div className="space-y-6">
          {step === 0 && <BasicsStep form={form} interests={interests} />}
