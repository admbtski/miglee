...
const REPORT_REASONS = [
  ...
  { value: 'MISLEADING', label: 'Fałszywa lub wprowadzająca w błąd recenzja' },
  { value: 'HARASSMENT', label: 'Nękanie lub atakowanie osobiste' },
  { value: 'HATE_SPEECH', label: 'Mowa nienawiści' },
  { value: 'OFF_TOPIC', label: 'Nie dotyczy wydarzenia' },
  ...
  return (
    <>
      <Modal
        ...
        variant="centered"
        size="md"
        labelledById="report-review-modal-title"
        ariaLabel="Zgłoś recenzję"
        header={
        ...
        content={
          <div className="space-y-4">
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Jeśli ta recenzja narusza regulamin lub zawiera nieodpowiednie
              treści, możesz ją zgłosić. Twoje zgłoszenie zostanie sprawdzone
              przez moderatorów.
            </p>
            ...
            {selectedReason === 'OTHER' && (
              <div>
                ...
                <textarea
                  ...
                  placeholder="Opisz szczegółowo, dlaczego zgłaszasz tę recenzję..."
