/**
 * Intent Management Dashboard Page
 * Overview and quick stats for event management
 */

import { Suspense } from 'react';
import { notFound } from 'next/navigation';
import { IntentManagementDashboard } from './_components/intent-management-dashboard';

type PageProps = {
  params: Promise<{ id: string }>;
};

export default async function IntentManagementPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      <IntentManagementDashboard intentId={id} />
    </Suspense>
  );
}
