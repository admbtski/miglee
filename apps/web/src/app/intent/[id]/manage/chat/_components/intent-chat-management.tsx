...
/**
 * Chat management component for intent/event
 * Embedded version of the chat modal for management pages
 */
export function IntentChatManagement({ intentId }: IntentChatManagementProps) {
  ...
  if (intentLoading || messagesLoading) {
    return (
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                ...
                {intent.joinedCount === 1 ? 'osoba' : 'osób'}
              </p>
            </div>
          </div>
        </div>
