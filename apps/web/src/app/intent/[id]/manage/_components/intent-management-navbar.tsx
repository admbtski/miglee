...
import { IntentManagementMobileSidebar } from './intent-management-mobile-sidebar';

interface IntentManagementNavbarProps {
  intentId: string;
}

/**
 * IntentManagementNavbar - Top bar for content area
 *
 * Features:
 ...
 * - Sticky positioning
 */
export function IntentManagementNavbar({
  intentId,
}: IntentManagementNavbarProps) {
