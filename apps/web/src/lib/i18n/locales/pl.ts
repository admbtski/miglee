export const pl = {
  ...
  notifications: {
    ...
    changedFields: {
      ...
      addressVisibility: 'widoczność adresu',
      membersVisibility: 'widoczność uczestników',
      joinOpensMinutesBeforeStart: 'otwarcie zapisów',
      joinCutoffMinutesBeforeStart: 'zamknięcie zapisów',
      allowJoinLate: 'późne dołączanie',
      lateJoinCutoffMinutesAfterStart: 'limit późnego dołączania',
      levels: 'poziomy',
